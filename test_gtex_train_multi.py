from gtex import GTExTissueAgeBootstrap60004
import pandas as pd
...
def test_OrganAge():
    ...
    data = GTExTissueAgeBootstrap60004.CreateGTExTissueAgeObject()
    df_prot = pd.read_csv(filepath_or_buffer="../../../gtex/proc/proc_data/artery_coronary.TEST.60004.tsv", sep='\s+').set_index("Name")
