from gtex import GTExTissueAgeBootstrap7708
import pandas as pd
...
def test_OrganAge():
    ...
    data = GTExTissueAgeBootstrap7708.CreateGTExTissueAgeObject()
    df_prot = pd.read_csv(filepath_or_buffer="../../../gtex/proc/proc_data/artery_coronary.TEST.7708.tsv", sep='\s+').set_index("Name")
