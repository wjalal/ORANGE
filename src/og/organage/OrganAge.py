...
class CreateOrganAgeObject:
    ...
    def load_data_and_models(self):
        ...
        version_scale_factors = json.load(resources.open_text("src.og.organage.data", self.data_and_model_paths["path_version_scale_factors"]))
        self.version_scale_factors = version_scale_factors

        # organ:proteinlist dictionary
        organ_plist_dict1 = json.load(resources.open_text("src.og.organage.data",
                                                         self.data_and_model_paths["path_organ_plist_dict1"]))
        organ_plist_dict2 = json.load(resources.open_text("src.og.organage.data",
        ...
        bootstrap_seeds = json.load(resources.open_text("src.og.organage.data", self.data_and_model_paths["path_bootstrap_seeds"]))["BS_Seed"]
        models_dict = {}
        ...
        for i in range(len(model_norms)):
            ...
            for organ in organ_plist_dict:
                ...
                loaded_model = pickle.loads(resources.read_binary('src.og.organage.data.ml_models.KADRC.'+norm+'.' + organ, fn_protein_scaler))
                ...
                loaded_model = pickle.loads(resources.read_binary('src.og.organage.data.ml_models.KADRC.'+norm+'.' + organ, fn_agegap_scaler))
                ...
                for seed in bootstrap_seeds:
                    ...
                    loaded_model = pickle.loads(resources.read_binary('src.og.organage.data.ml_models.KADRC.'+norm+'.'+ organ, fn_aging_model))
