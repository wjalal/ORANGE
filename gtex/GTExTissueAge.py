...
class CreateGTExTissueAgeObject:
    ...
    def __init__(self,
                #  path_version_scale_factors='v4_to_v4.1_scale_dict.json',
                 path_bootstrap_seeds='Bootstrap_and_permutation_500_seed_dict_15_2.json',
                 ):
    ...
    def load_data_and_models(self):
        ...
        for i in range(len(model_norms)):
            ...
            for organ in organ_plist_dict:
                ...
                loaded_model = pickle.loads(resources.read_binary('gtex.train_bs15_2.data.ml_models.gtexV8.HC.'+norm+'.' + organ, fn_protein_scaler))
                ...
                for seed in bootstrap_seeds:
                    ...
                    loaded_model = pickle.loads(resources.read_binary('gtex.train_bs15_2.data.ml_models.gtexV8.HC.'+norm+'.'+ organ, fn_aging_model))
