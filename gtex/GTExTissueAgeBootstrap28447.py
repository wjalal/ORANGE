    ...
    def load_data_and_models(self):
        ...
        for i in range(len(model_norms)):
            ...
            for organ in organ_plist_dict:
                ...
                loaded_model = pickle.loads(resources.read_binary('gtex.train_bs20_28447.data.ml_models.gtexV8.HC.'+norm+'.' + organ, fn_protein_scaler))
                ...
                for seed in bootstrap_seeds:
                    ...
                    loaded_model = pickle.loads(resources.read_binary('gtex.train_bs20_28447.data.ml_models.gtexV8.HC.'+norm+'.'+ organ, fn_aging_model))
