...
def Train_all_tissue_aging_model_elasticnet(md_hot_train, df_prot_train,
    ...
    for tissue in tissues:
        ...
        df_X_train = pd.concat([md_hot_train_tissue[["SEX"]], smp_attr[["SMTSISCH"]], df_prot_train_tissue], axis=1)
        df_X_train[['SMTSISCH']] = df_X_train[['SMTSISCH']].fillna(df_X_train[['SMTSISCH']].median())
