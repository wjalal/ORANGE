...
def test_OrganAge (tissue):
    ...
    data = GTExTissueAgeBootstrap.CreateGTExTissueAgeObject(tissue)
    df_prot = pd.read_csv(filepath_or_buffer="../../../gtex/proc/proc_data/reduced/corr" + gene_sort_crit + "/" + tissue + ".TEST.tsv", sep='\s+').set_index("Name")
...
for tissue in tissues:
    ...
    plt.savefig("gtex_outputs/lasso_PTyj_nma_tstScale_redc" + gene_sort_crit + "_train_bs10_" + tissue + ".png")
    plt.clf()
