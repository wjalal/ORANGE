from gtex import GTExTissueAgeBootstrap9
import pandas as pd
...
def test_OrganAge():
    ...
    data = GTExTissueAgeBootstrap9.CreateGTExTissueAgeObject()
    df_prot = pd.read_csv(filepath_or_buffer="../../../gtex/proc/proc_data/artery_coronary.TEST.9.tsv", sep='\s+').set_index("Name")
